  ...
  return (
    <View style={{ flex: 1 }}>
      <ScrollView
        ...
        contentContainerStyle={{ paddingBottom: Platform.OS === "web" ? 100 : insets.bottom + 120 }}
      ...
      >
        ...
        <View style={[styles.phaseCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <Text style={[styles.phaseProgressLabel, { color: colors.mutedForeground }]}>
            {Math.max(0, phaseInfo.maxMonths - ageMonths)} months remaining in {phaseInfo.label}
          </Text>
        </View>
      ...
      <Pressable
        ...
        style={[
          ...
          { 
            ...
            borderColor: "white",
            bottom: Platform.OS === 'web' ? 104 : insets.bottom + 90
          }
        ]}
      >
...
const styles = StyleSheet.create({
  ...
  aiBannerText: { flex: 1 },
  aiBannerTitle: { color: 'white', fontSize: 18, fontFamily: "Inter_700Bold" },
  aiBannerSub: { color: 'rgba(255,255,255,0.8)', fontSize: 12, fontFamily: "Inter_400Regular", marginTop: 2 },
  aiBannerIcon: { width: 44, height: 44, borderRadius: 22, backgroundColor: 'rgba(255,255,255,0.2)', justifyContent: 'center', alignItems: 'center' },
  floatingAiButton: {
    position: 'absolute',
    right: 20,
    width: 50,
  ...
  actionSubText: { fontSize: 10, fontFamily: "Inter_400Regular", textAlign: "center", marginTop: 2 },
  aiBadge: { position: 'absolute', top: -10, right: 10, backgroundColor: '#000', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 10 },
