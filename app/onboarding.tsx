      ...
      <LinearGradient colors={["#f7f3ee", "#e8f0e9"]} style={styles.container}>
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.header}>
            ...
            <Text style={[styles.tagline, { color: colors.mutedForeground }]}>Every child is a genius in bloom</Text>
          </View>

          {/* Card */}
          <View style={[styles.card, { backgroundColor: colors.card }]}>
            <Text style={[styles.cardTitle, { color: colors.foreground }]}>Let's set up your profile</Text>
            ...
            <View style={styles.fieldGroup}>
              <Text style={[styles.label, { color: colors.foreground }]}>Your child's name</Text>
              <TextInput
            ...
            {/* Parent Name */}
            <View style={styles.fieldGroup}>
              <Text style={[styles.label, { color: colors.foreground }]}>Your name (parent)</Text>
              <TextInput
                style={[styles.input, { borderColor: colors.border, color: colors.foreground, backgroundColor: colors.background }]}
            ...
            <View style={styles.fieldGroup}>
              ...
              <View style={styles.dobRow}>
                <TextInput
                  style={[styles.dobInput, styles.dobDay, { borderColor: colors.border, color: colors.foreground, backgroundColor: colors.background }]}
                  placeholder="DD"
                  placeholderTextColor={colors.mutedForeground}
                  value={dobDay}
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.monthScroll}>
                  {MONTHS.map((m, i) => (
                    ...
                    >
                      <Text style={[styles.monthText, { color: dobMonth === i ? "#fff" : colors.foreground }]}>{m}</Text>
                    </TouchableOpacity>
                  ))}
                </ScrollView>

                <TextInput
                  style={[styles.dobInput, styles.dobYear, { borderColor: colors.border, color: colors.foreground, backgroundColor: colors.background }]}
                  placeholder="YYYY"
                  placeholderTextColor={colors.mutedForeground}
                  value={dobYear}
            ...
            <View style={[styles.infoBox, { backgroundColor: colors.accent + "20", borderColor: colors.accent + "40" }]}>
              <Text style={[styles.infoTitle, { color: colors.foreground }]}>What gets personalised?</Text>
              {[
                ...
                <Text key={item} style={[styles.infoItem, { color: colors.mutedForeground }]}>{item}</Text>
              ))}
            </View>
          </View>
